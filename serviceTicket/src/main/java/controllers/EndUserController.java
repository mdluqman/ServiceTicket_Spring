...
public class EndUserController {
	...
	/*
	 * this function verifies if the details such as Requested-End-Date are given proper or not
	 * And if given correctly then the ticket for the user will be assigned to the appropriate ServiceEngineer
	 * 
	 * */
	...
	/*
	 * this function is used to display the logged in EndUsers ticket from the EndUserBean table(that 
	 * has records of all the tickets ever raised)  
	 * */
